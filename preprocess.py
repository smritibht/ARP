...
def prep_data(
    ...
    # subset data
    train_df = train_df[['Year','gdhi','Number of vehicles', 'population', 'Average variable unit price (£/kWh)',
                         'ULSP:  Pump price (p/litre)', 'ULSD: Pump price (p/litre)','NQF level 4 or above',
                         'NQF level 3 or above', 'NQF level 2 or above','latitude', 'longitude','Number of car models']]
    test_df = test_df[['Year','gdhi','Number of vehicles', 'population', 'Average variable unit price (£/kWh)',
                         'ULSP:  Pump price (p/litre)', 'ULSD: Pump price (p/litre)','NQF level 4 or above',
                         'NQF level 3 or above', 'NQF level 2 or above','latitude', 'longitude','Number of car models']]
